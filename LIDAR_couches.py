...
def LIDAR_couches(lidar_numpy, taille_xy=1.0, hauteur_couche=1.0, densite_min=1, prefixe_sauvegarde="layer"):
    """
...
def LIDAR_couches_LEGO(lidar_numpy, taille_xy=1.0, lego_ratio=5/3, densite_min=1, prefixe_sauvegarde="layer_LEGO"):
...
def LIDAR_couches_LEGO_LDRAW(lidar_numpy, taille_xy=1.0, lego_ratio=1.2, densite_min=1, prefixe_sauvegarde="layer_LEGO"):
...
if __name__ == "__main__":
    ...
    # === Version classique ===
    LIDAR_couches(LIDAR_numpy, taille_xy=1.0, hauteur_couche=1.0, densite_min=1, prefixe_sauvegarde="layer")
    # === Version LEGO ===
    LIDAR_couches_LEGO(LIDAR_numpy, taille_xy=1.0, lego_ratio=5/3, densite_min=1, prefixe_sauvegarde="layer_LEGO")
    # === Version LEGO LDRAW ===
    LIDAR_couches_LEGO_LDRAW(LIDAR_numpy, taille_xy=1.0, lego_ratio=1.2, densite_min=1, prefixe_sauvegarde="layer_LDRAW")

    # === Pour les données echantilonnées, ===
    # === Version classique ===
    LIDAR_couches(test_LIDAR_numpy, taille_xy=1.0, hauteur_couche=1.0, densite_min=1, prefixe_sauvegarde="layer")
    # === Version LEGO ===
    LIDAR_couches_LEGO(test_LIDAR_numpy, taille_xy=1.0, lego_ratio=5/3, densite_min=1, prefixe_sauvegarde="layer_LEGO")
    # === Version LEGO LDRAW ===
    LIDAR_couches_LEGO_LDRAW(test_LIDAR_numpy, taille_xy=1.0, lego_ratio=1.2, densite_min=1, prefixe_sauvegarde="layer_LDRAW")
